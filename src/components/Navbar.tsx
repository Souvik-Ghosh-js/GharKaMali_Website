      ...
      <nav style={{
        ...
        <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10 }}>
          <Link href="/" style={{ display: 'flex', alignItems: 'center', flexShrink: 0 }}>
            <img src="/logo.png" alt="GharKaMali" style={{ width: 50, height: 50, objectFit: 'contain', filter: isLight ? 'brightness(0) invert(1)' : 'none', transition: 'filter 0.4s' }} />
          </Link>
          ...
          {/* Desktop search bar */}
          <form onSubmit={handleSearch} className="nav-search-wrap" style={{ position: 'relative', display: 'flex', alignItems: 'center', flexShrink: 0 }}>
