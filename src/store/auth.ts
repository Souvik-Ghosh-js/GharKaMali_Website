...
interface User { id:number; name:string; phone:string; email?:string; role:string; profile_image?:string; referral_code?:string; address?:string; geofence_id?:number; }
