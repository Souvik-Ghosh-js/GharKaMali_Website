        ...
        <div className="container" style={{
          ...
          <div style={{ marginTop: 80, padding: 'clamp(40px,6vw,60px) clamp(24px,5vw,48px)', background: 'var(--forest)', borderRadius: 36, textAlign: 'center', position: 'relative', overflow: 'hidden', boxShadow: 'var(--sh-xl)' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <Link href="/book" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '14px 32px', background: '#fff', color: 'var(--forest)', borderRadius: 14, fontWeight: 800, textDecoration: 'none', transition: 'all 0.25s' }}>
                Book Consultation →
              </Link>
            </div>
          </div>
