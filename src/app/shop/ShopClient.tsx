...
const CATEGORY_ICONS: Record<string, () => JSX.Element> = {
  ...
  pots: () => (
    <svg
      ...
      strokeWidth="2.5"
    >
      <path d="M9 2h6l1 5H8z" />
      <path d="M8 7c0 0-2 1.5-2 7a6 6 0 0 0 12 0c0-5.5-2-7-2-7" />
    </svg>
  ),
  seeds: () => (
    <svg
    ...
    >
      ...
      <path d="M12 16.5V22M8 19.5l4-3 4 3" />
    </svg>
  ),
  pesticide: () => (
    <svg
...
export function ShopClient({ categorySlug }: { categorySlug?: string }) {
  ...
  useEffect(() => {
    getShopCategories()
      .then((d: any) => setCategories(["All", ...(Array.isArray(d) ? d : [])]))
      .catch(() => {});
  }, []);
  ...
  useEffect(() => {
    ...
    const match = categories.find(
      (c: any) =>
        typeof c !== "string" && (c.slug || slugify(c.name)) === categorySlug,
    );
  ...
  return (
    <SmoothScrollProvider>
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: "60%",
                  background:
                    "radial-gradient(ellipse, rgba(3,65,26,0.35) 0%, transparent 70%)",
                  pointerEvents: "none",
                }}
              />
              <div
                style={{
                  ...
                  inset: 0,
                  backgroundImage:
                    "linear-gradient(rgba(3,65,26,0.08) 1px, transparent 1px), linear-gradient(90deg, rgba(3,65,26,0.08) 1px, transparent 1px)",
              ...
              <div
                className="container shop-hero-content"
                style={{
                  position: "relative",
                  zIndex: 5,
                  height: "100%",
                  ...
                  <>
                    ...
                    <h1
                      style={{
                        ...
                        lineHeight: 0.95,
                        textShadow: "0 0 60px rgba(3,65,26,0.8)",
                        margin: 0,
                      }}
                    >
                      Everything your
                      <br />
                      <span style={{ color: "#c9a84c", fontStyle: "normal" }}>
                        garden needs
                      </span>
                    </h1>
                    <p
                    ...
                    >
                      Premium plants, quality tools, organic fertilizers —
                      curated by expert plant experts
                    </p>
                  </>
                )}
              </div>
        ...
        {mounted && cartCount > 0 && (
          <div
            style={{
              ...
              padding: "12px 0",
              boxShadow: "0 4px 20px rgba(3,65,26,0.3)",
            }}
          >
            <div
              className="container"
        ...
        >
          ...
          >
            ...
            >
              {categories.map((c) => {
                ...
                const slug =
                  typeof c === "string" ? "" : c.slug || slugify(c.name);
                const Icon =
                  CATEGORY_ICONS[name.toLowerCase()] || CATEGORY_ICONS["all"];
          ...
          {loading ? (
            ...
            >
              ...
              <h3 style={{ color: "var(--forest)", marginBottom: 8 }}>
                {search.trim()
                  ? "No products found"
                  : cat !== "All"
                    ? `${cat} coming soon!`
              ...
              <p style={{ color: "var(--text-muted)" }}>
                {search.trim()
                  ...
                  : cat !== "All"
                    ? `We're working on adding products to the ${cat} category.`
          ...
          >
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <p style={{ color: "rgba(255,255,255,0.55)", marginBottom: 28 }}>
                Book a gardener visit for personalized product recommendations
              </p>
              <Link
                href="/book"
                style={{
      ...
      <style jsx global>{`
        ...
        .product-grid {
          animation: gridFadeIn 0.45s ease both;
        }
        ...
        @media (min-width: 992px) {
          ...
          .search-sort-row > div:first-child {
            order: 1;
            width: 240px;
          }
        }
        ...
        @media (max-width: 768px) {
          ...
          .product-grid .product-tile Link > div:nth-child(2) > div:last-child {
            margin-bottom: 8px !important;
            gap: 4px !important;
          }
          .product-grid .product-tile > div:last-child {
            padding: 0 12px 12px !important;
          }
          .product-grid .product-tile > div:last-child > div {
            padding-top: 12px !important;
          }
          .product-grid .product-tile .price-val {
            font-size: 1.1rem !important;
          }
          .product-grid .product-tile button {
