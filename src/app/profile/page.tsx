    ...
    <>
      ...
      <div style={{ background: 'var(--bg)', paddingTop: 'var(--nav-h)', minHeight: '100svh', position: 'relative' }}>
        ...
        <div style={{ padding: '60px 0 100px', position: 'relative', overflow: 'hidden', borderBottom: '1px solid var(--border)' }}>
          <div className="container" style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 40, flexWrap: 'wrap' }}>
              ...
              <div>
                <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2.4rem,5vw,3.6rem)', fontWeight: 900, color: 'var(--forest)', marginBottom: 6, letterSpacing: '-0.02em', lineHeight: 1 }}>{user?.name}</h1>
        ...
        <div className="container-sm" style={{ marginTop: -50, paddingBottom: 80, position: 'relative', zIndex: 10 }}>
          ...
          {/* Profile form */}
          <div className="card" style={{ padding: '40px', marginBottom: 28, borderRadius: 32 }}>
            ...
            {editing ? (
              ...
              <div>
                {[
                  ...
                  <div key={row.label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 0', borderBottom: i < arr.length - 1 ? '1px solid var(--border)' : 'none' }}>
                    <span style={{ color: 'var(--sage)', fontWeight: 600, fontSize: '0.95rem' }}>{row.label}</span>
                    <span style={{ fontWeight: 800, fontSize: '1rem', color: 'var(--forest)' }}>{row.value}</span>
                  </div>
                ))}
              </div>
            )}
          ...
          {/* Danger zone */}
          <div className="card" style={{ padding: '32px', border: '1px solid #FCA5A5', background: '#FEF2F2', borderRadius: 28 }}>
